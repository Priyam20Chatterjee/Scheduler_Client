...
//         </div>
//       </div>
//       <div className="flex flex-col border w-full sm:w-[300px] h-[130px] shadow-sm bg-card rounded-lg">
    ...
    <section>
      <div className="flex flex-wrap justify-center gap-4 mt-5 px-4">
        <div className='flex flex-col gap-2'>
          <p className='text-black text-2xl sm:text-3xl font-semibold'>{getWelcomeMessage()}</p>
          <h6 className='text-gray-500'>Here's an overview of your tasks and schedule.</h6>
        </div>
        <div className='flex flex-col gap-2'>
          <h1 className="text-black text-xl sm:text-2xl font-bold tracking-wider">{formatDate(dateTime)}</h1>
          <p className="text-gray-500 text-sm font-semibold tracking-wider">{formatTime(dateTime)}</p>
        </div>
      </div>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mt-5 px-4">
        <div className='flex flex-col border w-full shadow-sm bg-card rounded-lg p-4'>
          <h4 className='text-black text-sm font-medium tracking-tight'>Total Task</h4>
          <h4 className='text-black text-2xl font-semibold tracking-tight mt-2'>0</h4>
        </div>
        <div className='flex flex-col border w-full shadow-sm bg-card rounded-lg p-4'>
          <h4 className='text-black text-sm font-medium tracking-tight'>Completed</h4>
          <h4 className='text-black text-2xl font-semibold tracking-tight mt-2 text-green-600'>0</h4>
        </div>
        <div className='flex flex-col border w-full shadow-sm bg-card rounded-lg p-4'>
          <h4 className='text-black text-sm font-medium tracking-tight'>Pending</h4>
          <h4 className='text-black text-2xl font-semibold tracking-tight mt-2 text-yellow-600'>0</h4>
        </div>
        <div className='flex flex-col border w-full shadow-sm bg-card rounded-lg p-4'>
          <h4 className='text-black text-sm font-medium tracking-tight'>Completion Rate</h4>
          <h4 className='text-black text-2xl font-semibold tracking-tight mt-2'>0%</h4>
        </div>
      </div>
    </section>
